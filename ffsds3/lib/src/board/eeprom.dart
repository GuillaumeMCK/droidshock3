...
final class Eeprom {
  ...
  Eeprom({int firmware = 0x0C08, int controllerType = 0x04})
    : bankA = Uint8List(256)
        ...
        ..setAll(0x20, const [
          0x00, 0x02, 0x00, 0x02, 0x00, 0x02, 0x00, 0x02, // default to 0x0200
      ...
      bankB = Uint8List(256)
        ...
        ..setAll(0x90, [
          // unknown — preserving factory bytes
          0x00, 0x6E, 0x03, 0x92, 0x00, 0x6A,
          //accel X bias = 0 , accel X gain = 1024 (0x0400)
          0x00, 0x00, 0x00, 0x04,
          // accel Y bias = 0, accel Y gain = 1024 (0x0400)
          0x00, 0x00, 0x00, 0x04,
          // accel Z bias = 0, accel Z gain = 1024 (0x0400)
          0x00, 0x00, 0x00, 0x04,
          // unknown — preserving factory bytes
          0x00, 0x5A, 0x03, 0xA6, 0x01, 0xFE,
          // gyro Z offset = 0
          0x00, 0x00,
          // unknown — preserving factory bytes
          0x01, 0x8B, 0x02, 0x00, 0x01, 0x8F, 0x02, 0x00,
        ])
